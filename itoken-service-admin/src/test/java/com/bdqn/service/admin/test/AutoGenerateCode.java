...
public class AutoGenerateCode {
    ...
    private static String author ="yxy";//作者名称
    private static String outputDir ="C:\\Users\\koko\\Desktop\\itokrn";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/itoken-service-admin?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="123456";//数据库密码
    private static String tablePrefix ="tb_sys";//数据库表的前缀，如tbl_user
    private static String [] tables = {"tb_sys_user"};	//生成的表
    private static String parentPackage = "com.bdqn.service.admin";//顶级包结构
